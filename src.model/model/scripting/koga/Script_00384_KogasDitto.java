...
public class Script_00384_KogasDitto extends PokemonCardScript {
	...
	public void moveToPosition(PositionID targetPosition) {
		...
		if (attackingPokemon.getDamageMarks() >= attackingPokemon.getHitpoints() && PositionID.isArenaPosition(targetPosition)
				&& !attackingPokemon.hasCondition(PokemonCondition.KNOCKOUT)) {
			attackingPokemon.setHitpoints(40);
