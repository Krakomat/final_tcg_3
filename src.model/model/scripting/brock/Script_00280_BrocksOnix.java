...
public class Script_00280_BrocksOnix extends PokemonCardScript {

	public Script_00280_BrocksOnix(PokemonCard card, PokemonGame gameModel) {
		super(card, gameModel);
		List<Element> att1Cost = new ArrayList<>();
		att1Cost.add(Element.COLORLESS);
		this.addAttack("Bellow", att1Cost);
