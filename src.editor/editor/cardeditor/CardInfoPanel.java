...
public class CardInfoPanel extends JPanel {
	...
	public CardInfoPanel(Card s, String[] pokemonNames) {
		...
		typeImages[0] = new BitmapComponent("/tilesets/elements/elektro.png").getImageIcon();
		typeImages[1] = new BitmapComponent("/tilesets/elements/feuer.png").getImageIcon();
		typeImages[2] = new BitmapComponent("/tilesets/elements/wasser.png").getImageIcon();
		typeImages[3] = new BitmapComponent("/tilesets/elements/pflanze.png").getImageIcon();
		typeImages[4] = new BitmapComponent("/tilesets/elements/kampf.png").getImageIcon();
		typeImages[5] = new BitmapComponent("/tilesets/elements/psycho.png").getImageIcon();
		typeImages[6] = new BitmapComponent("/tilesets/elements/normal.png").getImageIcon();
		ImageIcon[] elementImages = new ImageIcon[8];
		elementImages[0] = new BitmapComponent("/tilesets/elements/noElement.png").getImageIcon();
		elementImages[1] = new BitmapComponent("/tilesets/elements/elektro.png").getImageIcon();
		elementImages[2] = new BitmapComponent("/tilesets/elements/feuer.png").getImageIcon();
		elementImages[3] = new BitmapComponent("/tilesets/elements/wasser.png").getImageIcon();
		elementImages[4] = new BitmapComponent("/tilesets/elements/pflanze.png").getImageIcon();
		elementImages[5] = new BitmapComponent("/tilesets/elements/kampf.png").getImageIcon();
		elementImages[6] = new BitmapComponent("/tilesets/elements/psycho.png").getImageIcon();
		elementImages[7] = new BitmapComponent("/tilesets/elements/normal.png").getImageIcon();
