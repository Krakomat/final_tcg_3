...
public class Script_00319_MistysMagikarp extends PokemonCardScript {

	public Script_00319_MistysMagikarp(PokemonCard card, PokemonGame gameModel) {
		super(card, gameModel);
		List<Element> att1Cost = new ArrayList<>();
		att1Cost.add(Element.COLORLESS);
		this.addAttack("Play Dead", att1Cost);

		List<Element> att2Cost = new ArrayList<>();
		att2Cost.add(Element.COLORLESS);
		this.addAttack("Leap", att2Cost);
	}

	@Override
	public void executeAttack(String attackName) {
		if (attackName.equals("Play Dead"))
			this.PlayDead();
		else
			this.Leap();
	}
