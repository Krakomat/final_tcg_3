...
public class Script_00113_Pinsir extends PokemonCardScript {

	public Script_00113_Pinsir(PokemonCard card, PokemonGame gameModel) {
		...
		att2Cost.add(Element.COLORLESS);
		this.addAttack("Guillotine", att2Cost);
	}
